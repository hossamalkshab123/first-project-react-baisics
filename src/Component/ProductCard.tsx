    ...
    return (
        <div className="max-w-sm md:max-w-lg mx-auto md:mx-0 p-2 rounded-md border border-gray-200 shadow-xl">
            ...
            <div className="px-4 py-2">
                <h3 className="uppercase text-slate-900 font-bold">{title}</h3>
                <p className="text-slate-800 font-medium h-[48px]">{descriptionSlice(description)}</p>
                ...
                <div className="flex justify-between items-center mb-2">
                    <div className="font-medium">${numberWithCommas(price)}</div>
